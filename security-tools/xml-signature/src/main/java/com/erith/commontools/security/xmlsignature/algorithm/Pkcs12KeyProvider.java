...
public class Pkcs12KeyProvider implements PrivateKeyProvider {
	...
	public Pkcs12KeyProvider(XMLSignatureFactory factory, PrivateKeyData keyData) throws IOException,
			NoSuchAlgorithmException, KeyStoreException, CertificateException, UnrecoverableEntryException {
