...
public class SingleSignOnTest {
    private static File publicKeyFile = new File("C:/PGP_Key/public.txt16a4b637-5dff-4fed-9d22-10f922109f26");
    private static File privateKeyFile = new File("C:/PGP_Key/private.txtc4a620c5-2596-4660-82e1-be8262c9ba6e");
    ...
    //
    @Test
    public static void TestPGP(String[] args) {
        String TOKEN = "aamine";
